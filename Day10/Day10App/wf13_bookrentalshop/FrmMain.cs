...
namespace wf13_bookrentalshop
{
    ...
    {
        #region < 각화면 폼 >
        FrmGenre frmGenre = null; // 책장르 관리 객체 변수
        FrmBooks frmBooks = null; // 책정보 관리 객체 변수
        #endregion
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            TssLable.Text = "로그인 아이디 : ";
            TssLable.Text += Commons.LoginID;
            TssLable.Text += " / " + DateTime.Now.ToString();
        }
        ...
        {
            frmBooks = ShowActiveForm(frmBooks, typeof(FrmBooks)) as FrmBooks; // 이형태로 바꿔준다.
        }
